...
class FacebookDetail(username: Option[String], first: Option[String], last: Option[String],
                     fullName: Option[String], avURL: Option[String]) extends AuthenticatorDetail {
  def authenticator: Authenticators.Authenticators = Authenticators.Facebook
